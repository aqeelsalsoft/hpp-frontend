...
const imgSrc = '/images/sustainability-grid/kraft-tuck-top-boxes.jpg'
...
<template>
    <div class="flex items-center h-[calc(100vh_/_2)] w-6/12 bg-[#333333] relative overflow-hidden">
        <div
            ...
            loading="lazy" width="500" height="500" class="w-full h-full object-cover" />
        ...
        <div class="Inner absolute bottom-0 left-0 w-full">
            <div class="py-6 px-8">
                <h2 class="font-headings text-white text-[18px] font-bold">
                    <NuxtLink to="#">Kraft Tuck Top Boxes</NuxtLink>
                </h2>
            </div>
        </div>
    </div>
