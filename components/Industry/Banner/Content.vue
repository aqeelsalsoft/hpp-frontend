    ...
    <div class="hpp__categoryBannerContentWrapper pl-[15px] pr-[50px]">
        <div class="breadcrumbs__wrap mb-[20px]">
            <ul class="flex items-center gap-[10px]">
                ...
                <li><span>Custom Soap Boxes</span></li>
            </ul>
        </div>
        <div class="desc__wrap">
            <h1 class="font-headings text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Custom Soap Boxes</h1>
            <p class="font-description mt-6 text-[16px] leading-[24px] text-gray-600 mb-[30px]">Premium-quality and
                perfectly-dimensioned soap box complemented by custom cutouts, add-ons, and finishes for a strong first
