...
// const { hasCategories } = storeToRefs(useCategoriesStore());
...
const { data, status, error, refresh, clear } = await useAsyncData(
  'shapes-materials',
  () => $fetch(`${useRuntimeConfig().public.apiURL}/shapes-and-materials?industry=${slug}&type=0`),
  { initialCache: false }
);


console.log("dataa", data?.value?.related_products);
            ...
            <div class="container mx-auto px-[15px]">
                <div class="flex items-center mb-[30px]">
                    <div class="flex items-center">
                        <h2 class="font-headings text-[#212529] text-[36px] leading-[40px] font-bold mb-[10px]">{{data?.category?.sub_title}} Products</h2>
